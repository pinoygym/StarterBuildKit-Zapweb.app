...
export const accountsPayableSchema = z.object({
  ...
  withholdingTax: z.number().optional().default(0),
  salesDiscount: z.number().optional().default(0),
  rebates: z.number().optional().default(0),
  taxExemption: z.number().optional().default(0),
