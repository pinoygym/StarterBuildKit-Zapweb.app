...
import { Loader2, Trash2, Database, AlertTriangle, BarChart3, Settings as SettingsIcon, Save, Shield, TestTube, RefreshCw } from 'lucide-react';
...
export default function SettingsPage() {
  const { isSuperMegaAdmin } = useAuth();
  ...
  const handleDeleteTransactions = async () => {
    ...
    try {
      const response = await fetch('/api/settings/database/delete-transactions', {
        method: 'POST',
      });
