...
import { usePurchaseOrders, useReceivePurchaseOrder, useCancelPurchaseOrder } from '@/hooks/use-purchase-orders';
...
export default function PurchaseOrdersPage() {
  ...
  return (
    <div className="p-6">
      ...
      {!purchaseOrders || purchaseOrders.length === 0 && statusFilter === 'all' && branchFilter === 'all' ? (
        <EmptyState
          icon={FileText}
