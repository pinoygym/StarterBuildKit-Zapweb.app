    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(receivingVouchers?.reduce((sum, rv) => sum + Number(rv.totalReceivedAmount), 0) || 0)}
            </div>
          </CardContent>
        </Card>
      </div>
                  ...
                  filteredRVs.map((rv) => (
                    <TableRow key={rv.id}>
                      ...
                      <TableCell className="text-right">
                        {formatCurrency(Number(rv.totalOrderedAmount))}
                      </TableCell>
                      <TableCell className="text-right">
                        {formatCurrency(Number(rv.totalReceivedAmount))}
                      </TableCell>
                      <TableCell className="text-right">
                      ...
                      <TableCell>{rv.CreatedBy ? `${rv.CreatedBy.firstName} ${rv.CreatedBy.lastName}` : 'N/A'}</TableCell>
