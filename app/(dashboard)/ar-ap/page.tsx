  ...
  return (
    <div className="p-6">
      <PageHeader
        ...
        actions={
          activeTab === 'ar' ? (
            <Button onClick={() => router.push('/ar/payments/new')}>
              <ArrowRightLeft className="h-4 w-4 mr-2" />
              New Batch Payment
            </Button>
          ) : activeTab === 'ap' ? (
            <Button onClick={() => router.push('/ap/payments/new')}>
              <ArrowRightLeft className="h-4 w-4 mr-2" />
              New Batch Payment
            </Button>
          ) : undefined
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList>
          ...
          <TabsTrigger value="ar-payments" className="flex items-center gap-2">
        ...
        <TabsContent value="ar-payments" className="space-y-4">
          <Card className="p-6">
            <div className="text-center space-y-4">
              <FileText className="h-12 w-12 mx-auto text-muted-foreground" />
              <div>
                <h3 className="text-lg font-semibold">AR Payments Received Report</h3>
                <p className="text-sm text-muted-foreground mt-2">
                  View detailed report of all payments received from customers
                </p>
              </div>
              <Button onClick={() => router.push('/ar/payments-report')}>
                View Full Report
              </Button>
            </div>
          </Card>
