...
export default function ARPaymentsReportPage() {
    ...
    const handleExport = () => {
        ...
        const exportPayments = reportData.payments.map((payment) => ({
            'Payment Date': format(new Date(payment.paymentDate), 'yyyy-MM-dd'),
        ...
        exportData(
            exportPayments,
            'csv' as ExportFormat,
            `AR-Payments-Report-${format(new Date(), 'yyyy-MM-dd')}`
        );
