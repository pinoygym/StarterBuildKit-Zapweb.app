...
export async function POST(request: Request) {
  try {
    ...
    const record = await apService.createAP({
      ...
      otherCharges: body.otherCharges ? parseFloat(body.otherCharges) : undefined,
      withholdingTax: body.withholdingTax ? parseFloat(body.withholdingTax) : undefined,
      salesDiscount: body.salesDiscount ? parseFloat(body.salesDiscount) : undefined,
      rebates: body.rebates ? parseFloat(body.rebates) : undefined,
      taxExemption: body.taxExemption ? parseFloat(body.taxExemption) : undefined,
