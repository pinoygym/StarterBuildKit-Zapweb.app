...
describe('AR Payments Report API', () => {
    ...
    it('should return all payments without filters', async () => {
        const response = await fetch('http://localhost:3000/api/ar/payments-report', {
            method: 'GET',
            headers: authHeaders,
        });
    ...
    it('should filter payments by date range', async () => {
        ...
        const response = await fetch(
            `http://localhost:3000/api/ar/payments-report?fromDate=${fromDate}&toDate=${toDate}`,
            {
                method: 'GET',
                headers: authHeaders,
            }
    ...
    it('should filter payments by payment method', async () => {
        const response = await fetch(
            'http://localhost:3000/api/ar/payments-report?paymentMethod=Cash',
            {
                method: 'GET',
                headers: authHeaders,
            }
    ...
    it('should filter payments by reference number', async () => {
        const response = await fetch(
            'http://localhost:3000/api/ar/payments-report?referenceNumber=REF-001',
            {
                method: 'GET',
                headers: authHeaders,
            }
    ...
    it('should filter payments by customer name', async () => {
        const response = await fetch(
            'http://localhost:3000/api/ar/payments-report?customerName=Test Customer',
            {
                method: 'GET',
                headers: authHeaders,
            }
    ...
    it('should filter payments by branch', async () => {
        const response = await fetch(
            `http://localhost:3000/api/ar/payments-report?branchId=${testBranchId}`,
            {
                method: 'GET',
                headers: authHeaders,
            }
    ...
    it('should combine multiple filters correctly', async () => {
        ...
        const response = await fetch(
            `http://localhost:3000/api/ar/payments-report?fromDate=${fromDate}&toDate=${toDate}&paymentMethod=Cash&branchId=${testBranchId}`,
            {
                method: 'GET',
                headers: authHeaders,
            }
