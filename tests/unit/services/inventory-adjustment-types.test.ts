...
vi.mock('@/lib/prisma', () => {
    ...
    // implementation of $transaction that calls the callback with the mockPrisma itself
...
vi.mock('@/services/inventory.service', () => ({
    inventoryService: {
        ...
        convertToBaseUOM: vi.fn((productId, quantity, uom) => Promise.resolve(quantity)), // Simple mock implementation
    },
}));
