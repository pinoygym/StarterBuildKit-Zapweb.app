...
describe('AdjustmentForm', () => {
    ...
    const mockWarehouses: Warehouse[] = [
        { id: 'w1', name: 'Warehouse 1', address: 'Address 1', branchId: 'b1', createdAt: new Date(), updatedAt: new Date() }
    ];
    const mockBranches: Branch[] = [
        { id: 'b1', name: 'Branch 1', address: 'Address 1', phone: '1234567890', createdAt: new Date(), updatedAt: new Date() }
    ];
