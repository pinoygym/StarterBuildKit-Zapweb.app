...
(async function uomConversionTest() {
    ...
    const productName = 'Selenium Product 1764414407454';
    const caseQuantity = '5'; // 5 cases
    const conversionFactor = 12; // 1 case = 12 bottles (as you configured)
    ...
    try {
        ...
        // 2. Create Purchase Order using CASE UOM
        console.log(`2. Creating Purchase Order with ${caseQuantity} cases of ${productName}...`);
