...
export class APService {
  ...
  async getAgingReport(branchId?: string): Promise<APAgingReport> {
    ...
    for (const record of records) {
      ...
      buckets[bucketIndex].totalAmount = new Prisma.Decimal(buckets[bucketIndex].totalAmount).plus(
        record.balance
      );
      ...
      supplier.total = new Prisma.Decimal(supplier.total).plus(record.balance);
      supplier.aging[bucketIndex].count++;
      supplier.aging[bucketIndex].totalAmount = new Prisma.Decimal(
