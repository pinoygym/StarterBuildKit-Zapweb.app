...
export class WarehouseService {
  ...
  async getWarehouseById(id: string): Promise<WarehouseWithDetails> {
    console.log(`[WarehouseService] getWarehouseById called with id: ${id}`);
    const warehouse = await warehouseRepository.findById(id);
    if (!warehouse) {
      console.log(`[WarehouseService] Warehouse not found for id: ${id}`);
    ...
    try {
      ...
      console.error(`[WarehouseService] Error getting warehouse details:`, error);
      throw error;
    }
  }
