...
export class SalesOrderService {
   ...
   */
  async createSalesOrder(data: CreateSalesOrderInput, userId?: string): Promise<SalesOrderWithItems> {
    ...
    if (data.customerEmail) {
      createData.customerEmail = data.customerEmail;
    }

    const salesOrder = await salesOrderRepository.create(createData);
