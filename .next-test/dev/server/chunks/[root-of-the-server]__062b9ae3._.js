...
"[project]/Documents/GitHub/buenasv2/repositories/data-maintenance.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
class DataMaintenanceRepository {
    // Map reference data type to Prisma model
    getModel(type) {
        switch(type){
            case 'product-categories':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].productCategory;
            case 'expense-categories':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].expenseCategory;
            case 'payment-methods':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].paymentMethod;
            case 'units-of-measure':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].unitOfMeasure;
            case 'expense-vendors':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].expenseVendor;
            case 'sales-agents':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].salesAgent;
            default:
                throw new Error(`Unknown reference data type: ${type}`);
        }
    }
    async findAll(type, filters) {
    ...
    async updateDisplayOrder(type, updates) {
        const model = this.getModel(type);
        // Use transaction to update all display orders
        await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].$transaction(updates.map((update)=>model.update({
                where: {
                    id: update.id
                },
                data: {
    ...
    async incrementVendorUsage(vendorId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].expenseVendor.update({
            where: {
                id: vendorId
            },
            data: {
...
const dataMaintenanceRepository = new DataMaintenanceRepository();
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/Documents/GitHub/buenasv2/lib/validations/data-maintenance.validation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const baseReferenceDataSchema = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Name is required').max(100, 'Name must be 100 characters or less'),
    code: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Code is required').max(20, 'Code must be 20 characters or less').regex(/^[a-zA-Z0-9_-]+$/, 'Code must contain only letters, numbers, underscores, and hyphens'),
    description: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500, 'Description must be 500 characters or less').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    ...
    displayOrder: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(0).default(0),
    isSystemDefined: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().default(false)
});
const createProductCategorySchema = baseReferenceDataSchema;
const updateProductCategorySchema = baseReferenceDataSchema.partial();
const createExpenseCategorySchema = baseReferenceDataSchema;
const updateExpenseCategorySchema = baseReferenceDataSchema.partial();
const createPaymentMethodSchema = baseReferenceDataSchema.extend({
    applicableTo: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'expense',
        'pos',
        'ar',
        'ap'
    ])).min(1, 'Select at least one applicable context').default([
        'expense',
        'pos',
        'ar',
        'ap'
...
const createUnitOfMeasureSchema = baseReferenceDataSchema;
const updateUnitOfMeasureSchema = baseReferenceDataSchema.partial();
const createExpenseVendorSchema = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Vendor name is required').max(200, 'Name must be 200 characters or less'),
    contactPerson: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(100, 'Contact person must be 100 characters or less').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    phone: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(20, 'Phone must be 20 characters or less').regex(/^[\d\s\-\(\)\+]*$/, 'Invalid phone format').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    email: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().email('Invalid email format').max(100, 'Email must be 100 characters or less').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    status: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'active',
        'inactive'
    ]).default('active'),
...
const updateExpenseVendorSchema = createExpenseVendorSchema.partial();
const createSalesAgentSchema = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string({
        required_error: 'Agent name is required'
    }).min(1, 'Agent name is required').max(100, 'Name must be 100 characters or less'),
    code: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string({
        required_error: 'Code is required'
    }).min(1, 'Code is required').max(20, 'Code must be 20 characters or less').regex(/^[a-zA-Z0-9_-]+$/, 'Code must contain only letters, numbers, underscores, and hyphens'),
    contactPerson: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(100, 'Contact person must be 100 characters or less').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    phone: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(20, 'Phone must be 20 characters or less').regex(/^[\d\s\-\(\)\+]*$/, 'Invalid phone format').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    email: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().email('Invalid email format').max(100, 'Email must be 100 characters or less').nullish().or(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].literal('')),
    status: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
...
const updateSalesAgentSchema = createSalesAgentSchema.partial();
}),
...
"[project]/Documents/GitHub/buenasv2/lib/error-logger.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createErrorContext(request, additionalContext) {
    const context = {
        timestamp: new Date(),
        ...additionalContext
    };
...
"[project]/Documents/GitHub/buenasv2/lib/api-error.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$error$2d$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/lib/error-logger.ts [app-route] (ecmascript)");
;
;
;
/**
...
function formatErrorResponse(error, includeStack = false) {
    ...
    if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$zod$2f$v3$2f$ZodError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ZodError"]) {
        const { message, fields } = formatZodError(error);
        return {
            success: false,
            error: {
                code: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].VALIDATION_ERROR,
                message,
                fields,
                ...includeStack && {
                    stack: error.stack
    ...
    if (error.constructor.name.includes('Prisma')) {
        const appError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handlePrismaError"])(error);
        return {
            success: false,
            error: {
                code: appError.code,
    ...
    return {
        success: false,
        error: {
            code: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].INTERNAL_SERVER_ERROR,
...
function asyncHandler(handler) {
    return async (req, context)=>{
        try {
            ...
            const errorContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$error$2d$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorContext"])(req, {
                handler: handler.name || 'anonymous'
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$error$2d$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorLogger"].error('API request failed', error instanceof Error ? error : new Error(String(error)), errorContext);
            // Format error response
            const includeStack = ("TURBOPACK compile-time value", "development") === 'development';
            const errorResponse = formatErrorResponse(error instanceof Error ? error : new Error(String(error)), includeStack);
            // Determine status code
            const statusCode = error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"] ? error.statusCode : 500;
...
"[project]/Documents/GitHub/buenasv2/services/data-maintenance.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/repositories/data-maintenance.repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/lib/validations/data-maintenance.validation.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/lib/api-error.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/lib/errors.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
class DataMaintenanceService {
    ...
    getCreateSchema(type) {
        switch(type){
            case 'product-categories':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createProductCategorySchema"];
            case 'expense-categories':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createExpenseCategorySchema"];
            case 'payment-methods':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaymentMethodSchema"];
            case 'units-of-measure':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUnitOfMeasureSchema"];
            case 'expense-vendors':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createExpenseVendorSchema"];
            case 'sales-agents':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSalesAgentSchema"];
            default:
                throw new Error(`Unknown reference data type: ${type}`);
        }
    }
    ...
    getUpdateSchema(type) {
        switch(type){
            case 'product-categories':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateProductCategorySchema"];
            case 'expense-categories':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateExpenseCategorySchema"];
            case 'payment-methods':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updatePaymentMethodSchema"];
            case 'units-of-measure':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateUnitOfMeasureSchema"];
            case 'expense-vendors':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateExpenseVendorSchema"];
            case 'sales-agents':
                return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$validations$2f$data$2d$maintenance$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSalesAgentSchema"];
            default:
                throw new Error(`Unknown reference data type: ${type}`);
        }
    }
    ...
    async getAll(type, filters) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].findAll(type, filters);
    }
    async getById(type, id) {
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].findById(type, id);
        if (!item) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"](this.getTypeName(type));
        }
        return item;
    }
    async create(type, data) {
        ...
        if (!validationResult.success) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('Invalid data', errors);
        }
        const validatedData = validationResult.data;
        // Check for duplicate name
        const existingByName = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].findByName(type, validatedData.name);
        if (existingByName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('A record with this name already exists', {
                name: [
                    'Name must be unique'
                ]
            });
        ...
        if ('code' in validatedData) {
            const existingByCode = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].findByCode(type, validatedData.code);
            if (existingByCode) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('A record with this code already exists', {
                    code: [
                        'Code must be unique'
                    ]
                });
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].create(type, {
            ...validatedData,
            updatedAt: new Date()
        });
    }
    async update(type, id, data) {
        ...
        if ('code' in validatedData && validatedData.code && validatedData.code !== existing.code) {
            const existingByCode = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].findByCode(type, validatedData.code);
            if (existingByCode) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('A record with this code already exists', {
                    code: [
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].update(type, id, {
            ...validatedData,
            updatedAt: new Date()
        });
    }
    async delete(type, id) {
        ...
        if ('isSystemDefined' in existing && existing.isSystemDefined) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('Cannot delete system-defined records', {
                _general: [
                    'This is a system-defined record and cannot be deleted'
                ]
            });
        }
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].delete(type, id);
    }
    async updateDisplayOrder(type, updates) {
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$repositories$2f$data$2d$maintenance$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceRepository"].updateDisplayOrder(type, updates);
    }
...
const dataMaintenanceService = new DataMaintenanceService();
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
"[project]/Documents/GitHub/buenasv2/app/api/data-maintenance/[type]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$data$2d$maintenance$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/services/data-maintenance.service.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$data$2d$maintenance$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
[__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$data$2d$maintenance$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function GET(request, { params }) {
    try {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$data$2d$maintenance$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceService"].getAll(type, {
            status,
            search
        });
...
async function POST(request, { params }) {
    try {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$data$2d$maintenance$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dataMaintenanceService"].create(type, body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__062b9ae3._.js.map