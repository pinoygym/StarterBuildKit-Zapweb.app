...
"[project]/services/user.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$audit$2d$log$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
class UserService {
   ...
   */ async getAllUsers(filters, page = 1, limit = 20) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findAll(filters, page, limit);
    }
    /**
   * Get user by ID
   */ async getUserById(id) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findById(id);
    }
    /**
   * Get user by email
   */ async getUserByEmail(email) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findByEmail(email);
    }
    /**
   * Create new user
   */ async createUser(data, createdById, ipAddress, userAgent) {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findByEmail(data.email);
        if (existingUser) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ConflictError"]('Email already exists', {
                email: data.email
            });
        }
        // Hash password
        ...
        // Create user
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].create(createData);
        // Log the action
        await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$audit$2d$log$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auditLogRepository"].create({
            userId: createdById,
            action: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$audit$2e$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditAction"].USER_CREATED,
   ...
   */ async updateUser(id, data, updatedById, ipAddress, userAgent) {
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findById(id);
        if (!existingUser) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"]('User', id);
        }
        // Check if email is being changed and if it's already taken
        if (data.email && data.email !== existingUser.email) {
            const emailExists = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findByEmail(data.email);
            if (emailExists) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ConflictError"]('Email already exists', {
                    email: data.email
                });
        ...
        // Update user
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].update(id, updateData);
        // Log the action
        await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$audit$2d$log$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auditLogRepository"].create({
            userId: updatedById,
            action: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$audit$2e$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditAction"].USER_UPDATED,
            resource: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$audit$2e$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditResource"].USER,
            resourceId: id,
            details: {
                changes: data
   ...
   */ async deleteUser(id, deletedById, ipAddress, userAgent) {
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findById(id);
        if (!user) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"]('User', id);
        }
        // Soft delete by setting status to INACTIVE
        await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].update(id, {
            status: 'INACTIVE'
        });
        // Log the action
        await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$audit$2d$log$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auditLogRepository"].create({
            userId: deletedById,
            action: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$audit$2e$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditAction"].USER_DELETED,
            resource: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$audit$2e$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuditResource"].USER,
            resourceId: id,
            details: {
                email: user.email,
   ...
   */ async getUsersByRole(roleId, page = 1, limit = 20) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findAll({
            roleId
        }, page, limit);
    }
    /**
...
"[project]/repositories/permission.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class PermissionRepository {
   ...
   */ async findAll() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].permission.findMany({
            orderBy: [
                {
                    resource: 'asc'
                },
   ...
   */ async findById(permissionId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].permission.findUnique({
            where: {
                id: permissionId
            }
        });
   ...
   */ async findByRoleId(roleId) {
        const rolePermissions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].rolePermission.findMany({
            where: {
                roleId
            },
            include: {
   ...
   */ async findByUserId(userId) {
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].user.findUnique({
            where: {
                id: userId
            },
            include: {
...
"[project]/services/permission.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/repositories/permission.repository.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
class PermissionService {
    /**
   * Get all permissions
   */ async getAllPermissions() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionRepository"].findAll();
    }
    /**
   * Get permission by ID
   */ async getPermissionById(id) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionRepository"].findById(id);
    }
    /**
   * Get permissions by resource
   */ async getPermissionsByResource(resource) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionRepository"].findByResource(resource);
    }
    /**
   * Get permissions grouped by resource
   */ async getPermissionsGrouped() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionRepository"].findGroupedByResource();
    }
    /**
   * Check if user has specific permission
   */ async userHasPermission(userId, resource, action) {
        const permissions = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionRepository"].findByUserId(userId);
   ...
   */ async getUserPermissions(userId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$permission$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionRepository"].findByUserId(userId);
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/user.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$permission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/permission.service.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$permission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$permission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function GET(request) {
    ...
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].getUserById(payload.userId);
        ...
        const permissions = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$permission$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["permissionService"].getUserPermissions(payload.userId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__485b7df7._.js.map