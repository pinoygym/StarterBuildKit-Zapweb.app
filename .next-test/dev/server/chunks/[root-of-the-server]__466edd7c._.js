...
"[project]/Documents/GitHub/buenasv2/services/notification.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class NotificationService {
     ...
     */ async notifyAdmins(title, message, type, link) {
        ...
        const adminRoles = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].role.findMany({
            where: {
                name: {
                    in: [
                        'Super Admin',
        ...
        const admins = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].user.findMany({
            where: {
                roleId: {
                    in: roleIds
                },
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].notification.createMany({
    ...
    async getUnreadCount(userId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].notification.count({
            where: {
                userId,
                isRead: false
            }
...
"[project]/Documents/GitHub/buenasv2/app/api/notifications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/buenasv2/services/notification.service.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
[__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function GET(request) {
    try {
        ...
        if (!token) return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Unauthorized'
        }, {
            status: 401
        ...
        if (!payload) return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Invalid token'
        }, {
            status: 401
        ...
        await __turbopack_context__.A("[project]/Documents/GitHub/buenasv2/services/alert.service.ts [app-route] (ecmascript, async loader)").then((m)=>m.alertService.checkLowStock());
        const notifications = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notificationService"].getUserNotifications(payload.userId);
        const unreadCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notificationService"].getUnreadCount(payload.userId);
...
async function PATCH(request) {
    try {
        ...
        if (markAll) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notificationService"].markAllAsRead(payload.userId);
        } else if (id) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$services$2f$notification$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notificationService"].markAsRead(id);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$buenasv2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__466edd7c._.js.map