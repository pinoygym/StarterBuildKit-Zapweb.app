            ...
            {suppliers.map((supplier) => (
              <TableRow key={supplier.id}>
                ...
                <TableCell className="text-sm">
                  {(supplier as any).CreatedBy ? `${(supplier as any).CreatedBy.firstName} ${(supplier as any).CreatedBy.lastName}` : '-'}
                </TableCell>
                <TableCell className="text-sm">
                  {(supplier as any).UpdatedBy ? `${(supplier as any).UpdatedBy.firstName} ${(supplier as any).UpdatedBy.lastName}` : '-'}
                </TableCell>
                <TableCell>
                  <Badge
