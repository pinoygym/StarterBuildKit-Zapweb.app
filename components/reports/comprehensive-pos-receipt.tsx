...
export function ComprehensivePOSReceipt({
  ...
  const calculateDiscountAmount = () => {
    return sale.POSSaleItem.reduce((total, item) => {
  ...
  const getReceiptDataForQR = () => {
    return {
      ...
      items: sale.POSSaleItem.map(item => ({
        ...
        <div ref={receiptRef} className="space-y-4 p-4 bg-white text-black">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="info-row flex justify-between">
              ...
              <span className="info-value">{sale.User ? `${sale.User.firstName} ${sale.User.lastName}` : 'System'}</span>
            </div>
            {sale.Customer && (
              <div className="info-row flex justify-between">
          ...
          <div className="space-y-2">
            <table className="w-full text-sm">
              ...
              <tbody>
                {sale.POSSaleItem.map((item: any, index: number) => (
          ...
          {(showBarcode || showQRCode) && (
            <>
              ...
              <div className="flex justify-center items-center gap-4 py-2">
                ...
                {showQRCode && (
                  <div className="text-center">
                    <QRCodeSVG value={JSON.stringify(getReceiptDataForQR())} size={80} />
