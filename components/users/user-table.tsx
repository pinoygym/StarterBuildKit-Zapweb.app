...
import { MoreHorizontal, Pencil, Trash2, CheckCircle, Shield } from 'lucide-react';
                ...
                <TableRow key={user.id}>
                  <TableCell className="font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      {(user as any).isSuperMegaAdmin && (
                        <Badge variant="outline" className="border-orange-500 text-orange-600 bg-orange-50 dark:bg-orange-950/20 gap-1 px-2 py-0.5 h-5 text-[10px] font-bold">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          ...
                          disabled={(user as any).isSuperMegaAdmin}
                        >
