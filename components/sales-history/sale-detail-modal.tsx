        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              {sale.paymentMethod === 'credit' && (sale as any).partialPayment && Number((sale as any).partialPayment) > 0 && (
                <>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Partial Payment</span>
                    <span>{formatCurrency(Number((sale as any).partialPayment))}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Outstanding Balance</span>
                    <span className="text-orange-600">
                      {formatCurrency(Number(sale.totalAmount) - Number((sale as any).partialPayment))}
                    </span>
                  </div>
                </>
              )}
          ...
          {(sale as any).notes && (
            <>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{(sale as any).notes}</p>
              </div>
            </>
          )}
        </div>
