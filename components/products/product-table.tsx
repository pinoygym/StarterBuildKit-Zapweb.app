...
import { Edit, Trash2, ChevronDown, ChevronRight, Package, Tag, Wallet, Barcode, History } from 'lucide-react';
...
export function ProductTable({ products, onEdit, onDelete }: ProductTableProps) {
  ...
  const [selectedProductForHistory, setSelectedProductForHistory] = useState<ProductWithUOMs | null>(null);
  ...
  const handleHistoryClick = (product: ProductWithUOMs) => {
              ...
              <React.Fragment key={product.id}>
                <TableRow>
                  ...
                  */}
                  ...
                  <TableCell>
                    {product.CreatedBy ? `${product.CreatedBy.firstName} ${product.CreatedBy.lastName}` : '-'}
                  </TableCell>
                  <TableCell>
                    {product.UpdatedBy ? `${product.UpdatedBy.firstName} ${product.UpdatedBy.lastName}` : '-'}
                  </TableCell>
                  <TableCell>
                    <Badge
