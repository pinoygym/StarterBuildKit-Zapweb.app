...
export function SalesOrderInvoicePrint({
  ...
  const documentTitle = documentType === 'invoice' ? 'SALES INVOICE' : 'DELIVERY RECEIPT';
          ...
          <div className="grid grid-cols-2 gap-6 my-6">
            ...
            <div className="info-box border-2 border-gray-300 p-4 rounded-lg">
              ...
              <div className="space-y-2">
                ...
                {salesOrder.ciNumber && (
                  <div className="flex text-xs">
                    <span className="text-gray-600 font-medium min-w-[120px]">CI Number:</span>
                    <span className="font-semibold">{salesOrder.ciNumber}</span>
                  </div>
                )}
              </div>
            </div>
