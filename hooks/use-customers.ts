...
import { PaginationMetadata } from '@/types/customer.types';

// Fetch all customers
async function fetchCustomers(filters?: CustomerFilters): Promise<{ data: CustomerWithRelations[], pagination: PaginationMetadata }> {
