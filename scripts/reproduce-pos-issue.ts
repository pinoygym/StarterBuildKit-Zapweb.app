...
describe('POSService - Inventory Update Reproduction', () => {
    ...
    it('should correctly deduct inventory for multiple line items of the same product', async () => {
        ...
        (inventoryService.convertToBaseUOM as any).mockImplementation((pid: any, qty: any) => Promise.resolve(qty)); // Assume 1:1 conversion
        ...
        const updateCalls = (prisma.inventory.update as any).mock.calls;
