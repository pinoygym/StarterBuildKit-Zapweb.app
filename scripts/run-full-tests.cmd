...
powershell -Command "try { $r = Invoke-WebRequest -Uri 'http://localhost:3001' -TimeoutSec 5 -ErrorAction SilentlyContinue; Write-Host 'Server is ready!' } catch { Write-Host 'Server may still be starting...' }"
