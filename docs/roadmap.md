...
### Priority Backlog (Q1 2026) -> "Immediate Action"

#### 🛒 Sales & POS Overhaul
- [ ] **New Sales UI Module**: Redesign to match POS DB structure, strictly for "Invoice" type (prints Delivery Receipt)
- [ ] **Dynamic Pricing**: Editable Unit Selling Price (e.g., custom terms + add-on per sack)
- [ ] **Flexible Terms**: Custom term days (3, 7, 15, 30) manageable in settings
- [ ] **Remarks Field**: Add remarks text box in POS/Sales
- [ ] **Additional Charges**: Input box for delivery/other charges
- [ ] **Number Input UI**: Remove scrollbars from numeric inputs
- [ ] **Discount/Add-on**: "Add-on" box for extra amounts (e.g. +20/sack)

#### 🚛 Logistics & Inventory
- [ ] **Truck Management**: Loading/Unloading system, office admin updates
- [ ] **Delivery Receipt**: Update format, add CI (Commercial Invoice) Number
- [ ] **Pick List**: Warehouse pick list generation
- [ ] **Warehouse Lock**: "Transfer Only" mode (not for sale)
- [ ] **Validation**: Prevent negative on-hand quantity
- [ ] **Adjustment**: Show "Qty Before" and "Qty After"
- [ ] **UOM Filter**: Filter items missing UOM2

#### 💰 Finance & Accounting
- [ ] **Source of Funds**: Manage Banks, Cash on Hand, Vault (integrate with AR/AP)
- [ ] **AP Enhancements**: Print half-page, add totals for discount/withholding tax (show computation)
- [ ] **Remittance Report**: Daily report with cash denomination count
- [ ] **Expenses Series**: Tracking and reference
- [ ] **Rebates**: Customer rebate system based on quotas
- [ ] **Tax Toggle**: Vatable/Non-vatable selection per transaction/item

#### 🎛️ Admin & UX
- [ ] **Approval System**: "Mam Rocel" approval for cost changes/adjustments
- [ ] **Calendar**: Align days correctly, standardize format
- [ ] **UI Standardization**: Move hamburger to top-left, Action buttons to right
- [ ] **Bug Fix**: Product category visibility issue
