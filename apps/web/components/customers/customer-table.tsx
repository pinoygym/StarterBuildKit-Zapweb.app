              ...
              customers.map((customer) => (
                <TableRow key={customer.id}>
                  ...
                  <TableCell className="text-sm">
                    {customer.CreatedBy ? `${customer.CreatedBy.firstName} ${customer.CreatedBy.lastName}` : '-'}
                  </TableCell>
                  <TableCell className="text-sm">
                    {customer.UpdatedBy ? `${customer.UpdatedBy.firstName} ${customer.UpdatedBy.lastName}` : '-'}
                  </TableCell>
                  <TableCell>
                    <Badge
