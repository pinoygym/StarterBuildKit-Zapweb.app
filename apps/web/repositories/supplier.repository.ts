...
export class SupplierRepository {
  async findAll(filters?: SupplierFilters, options?: { skip?: number; take?: number }): Promise<Supplier[]> {
  ...
  async create(data: CreateSupplierInput & { createdById?: string }): Promise<Supplier> {
    return withErrorHandling(async () => {
      const { createdById, ...supplierData } = data;
  ...
  async update(id: string, data: UpdateSupplierInput & { updatedById?: string }): Promise<Supplier> {
    return withErrorHandling(async () => {
