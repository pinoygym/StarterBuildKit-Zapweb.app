module.exports = [
"[project]/services/alert.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AlertService {
   ...
   */ async checkLowStock(branchId) {
        ...
        const lowStockItems = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].inventory.findMany({
            where: {
                AND: [
                    {
                        Product: {
        ...
        for (const item of lowStockItems){
            if (item.quantity <= item.Product.minStockLevel) {
                ...
                const existingAlert = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].notification.findFirst({
                    where: {
                        type: 'LOW_STOCK',
                        isRead: false,
                        message: {
...
//# sourceMappingURL=services_alert_service_ts_98d8ecfe._.js.map