...
"[project]/services/dashboard.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DashboardService {
    async getKPIs(filters) {
        ...
        const [totalProducts, inventoryItems, activeSalesOrders, totalSalesOrders, convertedOrders, products, todaySales, arRecords, overdueReceivables, apRecords, overduePayables, expenses] = await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].product.count({
                where: {
                    status: 'active'
                }
            }),
            // Total stock units
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].inventory.findMany({
                where: {
                    ...filters?.branchId ? {
                        Warehouse: {
            ...
            // Active sales orders
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].salesOrder.count({
                where: {
                    status: {
                        in: [
                            'pending',
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].product.findMany({
                where: {
                    status: 'active'
                },
                include: {
            ...
            // Today's POS sales
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].pOSSale.findMany({
                where: {
                    createdAt: {
                        gte: today,
                        lt: tomorrow
            ...
            // Outstanding AR
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].accountsReceivable.findMany({
                where: {
                    status: {
                        in: [
                            'pending',
            ...
            // Overdue receivables
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].accountsReceivable.count({
                where: {
                    status: 'overdue',
                    ...filters?.branchId ? {
                        branchId: filters.branchId
            ...
            // Outstanding AP
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].accountsPayable.findMany({
                where: {
                    status: {
                        in: [
                            'pending',
            ...
            // Overdue payables
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].accountsPayable.count({
                where: {
                    status: 'overdue',
                    ...filters?.branchId ? {
                        branchId: filters.branchId
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].expense.findMany({
                where: {
                    expenseDate: {
                        gte: firstDayOfMonth
                    },
        ...
        const monthSales = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].pOSSale.findMany({
            where: {
                createdAt: {
                    gte: firstDay
                },
    ...
    async getTopSellingProducts(limit = 5, branchId) {
        const salesItems = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].pOSSaleItem.findMany({
            where: {
                ...branchId ? {
                    POSSale: {
                        branchId
    ...
    async getWarehouseUtilization(branchId) {
        const warehouses = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].warehouse.findMany({
            where: {
                ...branchId ? {
                    branchId
                } : {}
    ...
    async getBranchComparison() {
        const branches = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.findMany({
            where: {
                status: 'active'
            },
            include: {
    ...
    async getSalesTrends(days = 7, branchId) {
        ...
        const sales = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].pOSSale.findMany({
            where: {
                createdAt: {
                    gte: startDate,
                    lte: today
    ...
    async getLowStockProducts(limit = 10, branchId) {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].product.findMany({
            where: {
                status: 'active'
            },
            include: {
    ...
    async getEntityCounts(branchId) {
        const [products, warehouses, branches, customers, suppliers, purchaseOrders, receivingVouchers, salesOrders, users, roles] = await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].warehouse.count({
                where: {
                    ...branchId ? {
                        branchId
                    } : {}
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.count({
                where: {
                    status: 'active'
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].customer.count({
                where: {
                    status: 'active'
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].supplier.count({
                where: {
                    status: 'active'
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].purchaseOrder.count({
                where: {
                    status: {
                        not: 'cancelled'
                    },
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].receivingVoucher.count({
                where: {
                    ...branchId ? {
                        branchId
                    } : {}
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].role.count()
        ]);
        return {
            products,
            warehouses,
    ...
    async getSalesOrderSummary(branchId) {
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].salesOrder.groupBy({
            by: [
                'status'
            ],
            where: {
    ...
    async getRecentActivities(limit = 10, branchId) {
        const [sales, purchases, adjustments, expenses] = await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].purchaseOrder.findMany({
                where: {
                    ...branchId ? {
                        branchId
                    } : {}
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].inventoryAdjustment.findMany({
                where: {
                    ...branchId ? {
                        branchId
                    } : {}
...
"[project]/app/api/dashboard/orders-summary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/dashboard.service.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
...
async function GET(request) {
    try {
        ...
        const summary = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dashboardService"].getSalesOrderSummary(branchId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44165b48._.js.map