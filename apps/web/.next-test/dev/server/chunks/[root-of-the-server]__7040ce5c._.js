...
[__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
...
async function POST(request) {
    try {
        ...
        // Attempt login
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authService"].login(body, ipAddress, userAgent);
        if (!result.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7040ce5c._.js.map