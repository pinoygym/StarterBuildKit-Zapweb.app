...
"[project]/repositories/branch.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class BranchRepository {
    async findAll() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.findMany({
            orderBy: {
                name: 'asc'
            }
        });
    ...
    async findById(id) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.findUnique({
            where: {
                id
            }
        });
    ...
    async create(data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.create({
            data: {
    ...
    async update(id, data) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.update({
            where: {
                id
            },
            data
    ...
    async delete(id) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].branch.delete({
            where: {
                id
            }
        });
...
"[project]/lib/validations/branch.validation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const branchSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Branch name is required').max(100, 'Branch name is too long'),
    code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Branch code is required').max(20, 'Branch code is too long'),
    location: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Location is required').max(200, 'Location is too long'),
    manager: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Manager name is required').max(100, 'Manager name is too long'),
    phone: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Phone number is required').regex(/^[0-9+\-\s()]+$/, 'Invalid phone number format'),
...
"[project]/services/branch.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/repositories/branch.repository.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2f$branch$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/validations/branch.validation.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
class BranchService {
    async getAllBranches() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].findAll();
    }
    async getBranchById(id) {
        const branch = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].findById(id);
        if (!branch) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"]('Branch');
        }
        return branch;
    }
    async getActiveBranches() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].findActive();
    }
    async createBranch(data) {
        // Validate input
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2f$branch$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchSchema"].safeParse(data);
        if (!validationResult.success) {
            const errors = validationResult.error.flatten().fieldErrors;
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('Invalid branch data', errors);
        }
        // Check if branch code already exists
        const existingBranch = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].findByCode(data.code);
        if (existingBranch) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('Branch code already exists', {
                code: 'Branch code must be unique'
            });
        }
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].create(validationResult.data);
    }
    async updateBranch(id, data) {
        // Check if branch exists
        const existingBranch = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].findById(id);
        if (!existingBranch) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"]('Branch');
        }
        // Validate input
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validations$2f$branch$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateBranchSchema"].safeParse(data);
        if (!validationResult.success) {
            const errors = validationResult.error.flatten().fieldErrors;
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('Invalid branch data', errors);
        }
        ...
        if (data.code && data.code !== existingBranch.code) {
            const branchWithCode = await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].findByCode(data.code);
            if (branchWithCode) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValidationError"]('Branch code already exists', {
                    code: 'Branch code must be unique'
                });
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].update(id, validationResult.data);
    }
    async deleteBranch(id) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$repositories$2f$branch$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchRepository"].delete(id);
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$branch$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/branch.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/errors.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$branch$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$branch$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function GET() {
    try {
        const branches = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$branch$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchService"].getAllBranches();
...
async function POST(request) {
    try {
        ...
        const branch = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$branch$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["branchService"].createBranch(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: branch
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5189ffeb._.js.map