...
export interface UpdateSalesAgentInput extends Partial<CreateSalesAgentInput> { }
...
export const REFERENCE_DATA_CONFIGS: Record<ReferenceDataType, ReferenceDataConfig> = {
  ...
  'sales-agents': {
    type: 'sales-agents',
    title: 'Sales Agents',
    singularTitle: 'Sales Agent',
    description: 'Manage sales agents for POS transactions',
    icon: 'User',
    fields: [
      { name: 'name', label: 'Agent Name', type: 'text', required: true, placeholder: 'e.g., John Doe' },
      { name: 'code', label: 'Code', type: 'text', required: true, placeholder: 'e.g., AG001' },
      { name: 'contactPerson', label: 'Contact Person', type: 'text', placeholder: 'Optional' },
      { name: 'phone', label: 'Phone', type: 'phone', placeholder: 'Optional' },
      { name: 'email', label: 'Email', type: 'email', placeholder: 'Optional' },
    ],
