...
export async function seedUsers(prisma: PrismaClient) {
    ...
    for (const user of users) {
        ...
        if (user.email === 'cybergada@gmail.com') {
            passwordHash = await bcrypt.hash('Qweasd145698@', 12);
        }
